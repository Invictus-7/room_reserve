...
from app.api.endpoints.validators import check_meeting_room_exists, check_name_duplicate
from app.core.db import get_async_session
from app.core.user import current_superuser
# Вместо импортов 6 функций импортируем один объект meeting_room_crud.
...
@router.post(
    ...
    # Шаг_50 - ограничиваем права доступа к отдельным функциям,
    # например - создавать переговорки может только суперюзер
...
@router.get('/{meeting_room}/reservations',
